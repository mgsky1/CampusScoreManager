...
<html>
	...
	<body>
     ...
     <div class="container marginBar">
        ...
        <form class="form-inline" method="post" action="addStu">
        	
        	<div class="form-item">
        	    <section class="inner-item">
        		  <label>真实姓名：</label>
        		  <input type="text" class="form-control" name="realName" id="realName" autofocus="autofocus"/>
        		</section>
        	</div>
        	...
        	<div class="form-item">
        	    <section class="inner-item">
        		  <label>登陆名：</label>
        		  <input type="text" class="form-control" name="loginName" id="loginName" data-toggle="tooltip" data-placement="right" title="建议使用学生姓名缩写作为默认登录名"/>
        		</section>
        	</div>
        	...
        	<div class="form-item">
        	    <section class="inner-item">
        		  <label>初始密码：</label>
        		  <input type="text" class="form-control" name="pwd" value="123456" readonly="readonly"/>
        		</section>
        	</div>
